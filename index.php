...
<html><head>
    ...
    <base href="http://localhost/cubbyrabbit/">
  ...
  <body id="pakarkelinci" class="hold-transition skin-green-light sidebar-mini">
    <div class="wrapper">
      <!-- Main Header -->
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b><i class="fa fa-contao" aria-hidden="true"></i>R</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><i class="fa fa-contao" aria-hidden="true"></i>ubby Rabbit</b></span>
        </a>
        <!-- Header Navbar -->
                      ...
                      <li class="user-header">
                        ...
                        <p>
                         Login sebagai <?php echo ucfirst($_SESSION['username']); ?>
                          <small>Pakar dari Cubby Rabbit</small>
                        </p>
                      </li>
                      <!-- Menu Body -->
                      <li class="user-body">
...
function kirimContactForm(){
    ...
    if(nama.trim() == '' ){
        ...
        <strong><div class="cinta">Dikembangkan Tahun 2022 - Cubby Rabbit Farm <i class="fa fa-heart pulse"></i> by <a href="http://instagram.com/ahmad_xsam" target="_blank">Ahmadxsam</a></div></strong>
      </footer>
